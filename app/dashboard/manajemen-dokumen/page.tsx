...
import { FileText, Upload, Trash2, AlertTriangle, Eye, X } from "lucide-react";
...
export default function ManajemenDokumen() {
  ...
  const getPreviewUrl = (filename: string) => {
    return `${process.env.NEXT_PUBLIC_API_URL}/database/preview/${filename}`;
  };
          ...
          <div className="bg-white rounded-lg w-full max-w-6xl h-full max-h-[90vh] flex flex-col">
            ...
            <div className="flex-1 p-4">
              ...
              {previewLoading && (
                <div className="absolute inset-0 flex items-center justify-center bg-white bg-opacity-75">
                  <LoadingSpinner message="Memuat preview..." />
                </div>
              )}
            </div>
            ...
            <div className="p-4 border-t bg-gray-50 flex justify-between">
              <p className="text-sm text-gray-500">
                Anda dapat mengunduh dokumen ini untuk melihatnya secara
                lengkap.
              </p>
              <button
                onClick={closePreviewModal}
